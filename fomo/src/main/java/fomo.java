...
public class fomo {
    ...
    // 合约地址，第一次部署之后记录下来
    public static String ADDRESS = "0xA62142888ABa8370742bE823c1782D17A0389Da1";

    public static BigInteger KEYPEICE;

    public static String account;

    public static Fomo3d contract;
    ...
    private void run() throws Exception {
        ...
        contract = Fomo3d.load(ADDRESS, web3j, credentials, GAS_PRICE, GAS_LIMIT);
    ...
    public String getCurrentLeader(Fomo3d contract) throws Exception{
        try {
            Tuple14<BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, String, byte[], BigInteger, BigInteger, BigInteger, BigInteger, BigInteger> result = contract.getCurrentRoundInfo().send();
    ...
    public void buyIn(Web3j web3j, Fomo3d contract) throws Exception{
    ...
    public String buyAction(Web3j web3j, Fomo3d contract, int retryCount) throws Exception {
